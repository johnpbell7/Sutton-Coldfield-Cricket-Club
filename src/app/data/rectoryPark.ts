...
export const rectoryParkSections: GroundSection[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "The replacement was not ready for the start of the season. Delays, weather and surface drainage problems left it usable but, in the club's own words, \"in a somewhat chaotic state\" — the club muddled through to the end of May 1970, by which time it was seasonably presentable, though a good deal of finishing remained. One later account puts the opening at 1974 and the eventual cost between twelve and fifteen thousand pounds; the club's contemporary record is of a building in use through 1970.",
    ],
